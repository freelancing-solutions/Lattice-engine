          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
                Help &
                <span className="bg-gradient-to-r from-primary to-orange-400 bg-clip-text text-transparent"> Support</span>
              </h1>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
                Find answers to your questions or get in touch with our support team. 
                We're here to help you succeed with Lattice Engine.
              </p>
              <div className="flex flex-wrap justify-center gap-2 mb-8">
                <Badge variant="secondary" className="bg-primary text-primary-foreground">24/7 Documentation</Badge>
                <Badge variant="secondary" className="bg-blue-600 text-white">Active Community</Badge>
                <Badge variant="secondary" className="bg-green-600 text-white">24hr Response Time</Badge>
                <Badge variant="secondary" className="bg-orange-600 text-white">Expert Support</Badge>
              </div>
            </motion.div>
          </div>
        </section>
